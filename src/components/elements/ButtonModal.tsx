...
import ProductList from "../marketing/Products/ProductList";
        ...
        <Modal>
          ...
          <ModalBody>
            <ModalContent className="max-h-[90vh] overflow-y-auto">
              <div className="sticky top-0 bg-white dark:bg-gray-800 z-10 pb-5">
                <h4
                    ...
                    {images.map((image, idx) => (
                      ...
                      >
                        <img
                          src={image}
                          alt="aliments images"
                          className="rounded-lg object-cover flex-shrink-0 w-24 h-24 md:w-32 md:h-32"
                        />
                      </motion.div>
                    ))}
                  </div>
