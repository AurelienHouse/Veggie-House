...
const Slide = ({children, category, title, image}) => {
    return(
        ...
        <img src={image} alt="Image d'un evenement à venir" className="bg-primary absolute top-0 left-0 w-full h-full object-cover object-bottom z-0" />
        </div>
...
const items = [
    ...
    >
       Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptates temporibus sapiente enim molestiae, perspiciatis cum amet, eius consectetur voluptate dicta odit officia fugit atque consequatur a cupiditate labore repudiandae quae?
    </Slide>,
    <Slide
    image={Image02}
